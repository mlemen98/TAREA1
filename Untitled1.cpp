...
int main(){
    ...
    **/
    ...
    do{
        system("cls");
        cout<<"\t\t\t\t\tEMPRESA"<<endl;
        cout<<"\t\t\tIngresar trabajador............[1]"<<endl;
        cout<<"\t\t\tVer listado....................[2]"<<endl;
        cout<<"\t\t\tEliminar trabajador............[3]"<<endl;
        cout<<"\t\t\tSALIR..........................[4]"<<endl;
...
float salario;
	...
	total=sub+c.salario;
	iggs=0.0483*total;
    cout<<"\t\t\tEL SALARIO ES: "<<total;
    cout<<"\t\t\t EL IGGS ES:"<<iggs<<endl;
    }cin.ignore();
    system ("pause");
    return c;
...
void mostrarContacto(Contacto c){
    ...
    cout<<"\t\t\t SALARIO     : "<<c.salario<<endl;
    cout<<"\t\t\t HORAS TRABAJADAS   : "<<c.ht<<endl;
    cout<<endl;
}
